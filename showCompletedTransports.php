...
$sql = "SELECT * FROM transactioninfor WHERE payment_status = 'Paid'";
...
foreach($TransactionInfor as $Transaction){
    echo implode(',', [$Transaction['bookingID'], $Transaction['customer_name'], $Transaction['customer_phone'], 
    $Transaction['goods_type'], $Transaction['weight'], $Transaction['vehicle_type'], $Transaction['vehicle_plate'], 
    $Transaction['driver_id'], $Transaction['driver_name'], $Transaction['driverphone'],  $Transaction['payment_method'], 
    $Transaction['payment_number'],  $Transaction['payment_code'],  $Transaction['amoun_paid'], $Transaction['payment_status']]). "\n";
