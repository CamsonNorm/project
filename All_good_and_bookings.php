...
$sql = "SELECT bookinginformation. *, user_table.* FROM bookinginformation INNER JOIN user_table ON bookinginformation.user_id = user_table.user_id";
...
foreach($customers as $customer){
    echo implode(',', [$customer['bookingID'], $customer['goodsType'], $customer['wieght'], $customer['description'], 
    $customer['pickupLocation'], $customer['dropoffLocation'], $customer['date'], $customer['first_name'], $customer['email'], 
    $customer['phone'], $customer['vehicleType'], $customer['vehiclePlate']]). "\n";
