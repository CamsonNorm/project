...
$sql = "SELECT vehicleID, vehicleType, vehiclecapacity, plateNumer, vehiclemake, vehiclemodel FROM vehicle WHERE vehicle_status = 'Available'";
...
foreach($vehilceslist as $vehcile){
    echo implode(',', [$vehcile['vehicleID'], $vehcile['vehicleType'], $vehcile['vehiclecapacity'], $vehcile['plateNumer'], 
    $vehcile['vehiclemake'], $vehcile['vehiclemodel']]). "\n";
